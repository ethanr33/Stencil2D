...
class Image : public Renderable {
    private:
        ...
        void construct_fragments(uint8_t color_type, uint8_t bit_depth, const std::vector<uint8_t>& raw_data, const std::vector<Color>& palette, const std::vector<uint8_t>& transparencies, Color background_color);
    public:
